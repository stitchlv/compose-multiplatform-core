...
import com.bytedance.kmp.harko.skia.Font as SkFont
import com.bytedance.kmp.harko.skia.FontStyle as SkFontStyle
import com.bytedance.kmp.harko.skia.paragraph.Alignment as SkAlignment
import com.bytedance.kmp.harko.skia.paragraph.DecorationLineStyle as SkDecorationLineStyle
import com.bytedance.kmp.harko.skia.paragraph.DecorationStyle as SkDecorationStyle
import com.bytedance.kmp.harko.skia.paragraph.Direction as SkDirection
import com.bytedance.kmp.harko.skia.paragraph.Paragraph as SkParagraph
import com.bytedance.kmp.harko.skia.paragraph.ParagraphBuilder as SkParagraphBuilder
import com.bytedance.kmp.harko.skia.paragraph.Shadow as SkShadow
import com.bytedance.kmp.harko.skia.paragraph.TextIndent as SkTextIndent
import com.bytedance.kmp.harko.skia.paragraph.TextStyle as SkTextStyle
import com.bytedance.kmp.harko.skia.paragraph.FontRastrSettings as SkFontRastrSettings
...
import com.bytedance.kmp.harko.skia.FontFeature
import com.bytedance.kmp.harko.skia.Paint
import com.bytedance.kmp.harko.skia.paragraph.*
import com.bytedance.kmp.harko.skia.paragraph.ParagraphStyle
...
internal actual fun ActualParagraph(
    ...
    paragraphIntrinsics as ParagraphIntrinsics,
    maxLines,
    ellipsis,
    constraints
)
...
internal data class ComputedStyle(
    ...
    private fun toTextPaint(): Paint? = Paint().let {
        with(it.asComposePaint()) {
            ...
            return@let it.takeIf { shader != null || style != androidx.compose.ui.graphics.PaintingStyle.Fill || !it.isSrcOver }
        }
    }
...
internal class ParagraphBuilder(
    ...
    fun build(): SkParagraph {
        ...
        val fontCollection = when (platformFontLoader) {
            is FontLoader -> platformFontLoader.fontCollection
    ...
    private fun makeSkTextStyle(style: ComputedStyle): SkTextStyle {
        if (getpid().toLong() != syscall(SYS_gettid.toLong())) {
...
fun FontStyle.toSkFontStyle(): SkFontStyle {
    return when (this) {
        FontStyle.Italic -> com.bytedance.kmp.harko.skia.FontStyle.ITALIC
        else -> com.bytedance.kmp.harko.skia.FontStyle.NORMAL
    }
}
