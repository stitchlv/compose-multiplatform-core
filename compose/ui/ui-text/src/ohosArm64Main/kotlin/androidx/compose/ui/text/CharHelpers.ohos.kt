...
// todo 默认只支持Ltr，后面根据情况添加
internal fun CodePoint.strongDirectionType(): StrongDirectionType = StrongDirectionType.Ltr

// todo 暂不支持isNeutralDirection，后面根据情况添加
internal fun CodePoint.isNeutralDirection(): Boolean = false
