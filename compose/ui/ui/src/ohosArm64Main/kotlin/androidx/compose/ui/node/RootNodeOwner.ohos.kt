...
import androidx.compose.ui.platform.WeakHashSet
...
internal class RootNodeOwner(
    ...
    private val disableRecycleNode: Boolean,
) {
    ...
    val compositionDataSet: WeakHashSet<CompositionData> = WeakHashSet<CompositionData>()
    ...
    fun onPointerInput(event: PointerInputEvent): ProcessResult {
    ...
    private inner class OwnerImpl(
        ...
        override fun registerOnLayoutCompletedListener(listener: Owner.OnLayoutCompletedListener) {
            ...
            if (listener !is ComposeSceneMediator) {
                snapshotInvalidationTracker.requestLayout()
            }
        }
    }
